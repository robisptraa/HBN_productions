            ...
            <div class="p-6 text-gray-900 dark:text-gray-100">
                <form method="POST" action="{{ route('packages.update', $package) }}">
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="title" value="{{ old('title', $package->title) }}"
                    ...
                    <div class="mb-4">
                        ...
                        <x-text-input id="expiration_time"
                            value="{{ old('expiration_time', $package->expiration_time) }}" class="block mt-1 w-full"
                            type="number" name="expiration_time" required />
                    </div>

                    <div class="mb-4">
                        <x-input-label for="background_color" value="Warna Background" />
                        <x-text-input id="background_color"
                            value="{{ old('background_color', $package->background_color) }}" class="block mt-1 w-full"
                            type="color" name="background_color" />
                    </div>

                    <div class="mb-4">
                        <x-input-label for="price" value="Harga" />
                        <x-text-input id="price" value="{{ old('price', $package->price) }}"
                            class="block mt-1 w-full" type="number" step="0.01" name="price" required />
                    </div>
